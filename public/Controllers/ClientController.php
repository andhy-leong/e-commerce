...
class ClientController {
    ...
    public function afficherAccueil() {
        $tri = isset($_GET['tri']) ? $_GET['tri'] : 'defaut';
        ...
        $produits = $this->produitModel->getAllProduits($orderBy); 
    ...
    public function login($email, $motDePasse) {
        ...
        if ($client && password_verify($motDePasse, $client['mot_de_passe'])) {
            ...
            header('Location: client.php?action=accueil'); // Redirection vers l'accueil
