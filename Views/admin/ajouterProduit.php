...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../public/css/ajouterProduitAdmin.css"/>
</head>
<body>
<header>
    <div>
...
<form action="admin.php?action=ajouterProduit" method="post">
    ...
    <p><i>Pour ajouter le lien d'une image, veuillez insérer: ../Ressources/Vangovango/(l'image du produit.l'extension)</i></p>
